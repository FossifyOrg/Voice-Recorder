...
/**
 * Given a tree URI of some directory (such as obtained with `ACTION_OPEN_DOCUMENT_TREE` intent), returns a corresponding parent URI to create child documents
 * in that directory.
 */
